...
namespace ur_kinematics {
  ...
  int inverse(const double* T, double* q_sols, double q6_des) {
    ...
    // NOTE THAT THIS T NEEDS TO BE LOOKING EXACTLY LIKE WHAT forward_all RETURNS FOR THE END-EFFECTOR.
    double T00 = T[0];
    double T01 = T[1];
    double T02 = T[2];
    double T03 = T[3];
    ...
    // std::cout << "\n RESTRUCT \n" << std::endl;
    // std::cout << "T00,T01,T02 :" << T00 << "," << T01 << "," << T02 << std::endl;
    // std::cout << "T10,T11,T12 :" << T10 << "," << T11 << "," << T12 << std::endl;
    // std::cout << "T20,T21,T22 :" << T20 << "," << T21 << "," << T22 << std::endl;
    // std::cout << "\n END \n" << std::endl;
